...
var c_12261 = (a[i]);
if(cljs.core.truth_((c_12261["cljsIsDirty"]))){
(c_12261["forceUpdate"])();
} else {
}
...
var G__12264 = ((function (this$){
return (function (){
return this$.run_queue();
});})(this$))
;
return (reagent.impl.batching.next_tick.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.batching.next_tick.cljs$core$IFn$_invoke$arity$1(G__12264) : reagent.impl.batching.next_tick.call(null,G__12264));
}
});
...
var G__12266 = c;
var G__12266__$1 = (((G__12266 == null))?null:(G__12266["props"]));
if((G__12266__$1 == null)){
return null;
} else {
return (G__12266__$1["argv"]);
}
});
...
var G__12268_12269 = (c["cljsRatom"]);
if((G__12268_12269 == null)){
} else {
reagent.ratom.dispose_BANG_(G__12268_12269);
}
