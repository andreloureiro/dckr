...
var G__12369 = o;
(G__12369[reagent.impl.template.cached_prop_name(k)] = reagent$impl$template$convert_prop_value(v));
...
var old_12373 = (p["className"]);
(p["className"] = ((cljs.core.some_QMARK_(old_12373))?[cljs.core.str(class$),cljs.core.str(" "),cljs.core.str(old_12373)].join(''):class$));
} else {
}
...
var G__12376 = jsprops;
(G__12376["defaultValue"] = value);

(G__12376["onChange"] = ((function (G__12376,v,value,on_change){
return (function (p1__12374_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__12374_SHARP_);
});})(G__12376,v,value,on_change))
);
...
var vec__12378 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12378,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12378,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12378,(2),null);
...
var temp__4659__auto__ = (function (){var G__12382 = cljs.core.meta(v);
if((G__12382 == null)){
return null;
} else {
return reagent.impl.template.get_key(G__12382);
}
})();
if((temp__4659__auto__ == null)){
...
var jsprops = {"argv": v};
var G__12384_12385 = v;
var G__12384_12386__$1 = (((G__12384_12385 == null))?null:reagent.impl.template.key_from_vec(G__12384_12385));
if((G__12384_12386__$1 == null)){
} else {
(jsprops["key"] = G__12384_12386__$1);
}
...
var G__12390 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__12390) : reagent.impl.template.as_element.call(null,G__12390));
} else {
var p = (function (){var temp__4659__auto__ = (function (){var G__12391 = cljs.core.meta(argv);
if((G__12391 == null)){
return null;
} else {
return reagent.impl.template.get_key(G__12391);
}
})();
if((temp__4659__auto__ == null)){
return jsprops;
...
var G__12392 = (((jsprops == null))?{}:jsprops);
(G__12392["key"] = key);
...
var G__12393 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__12393;
continue;
}
} else {
...
var n__7121__auto___12394 = a.length;
var i_12395 = (0);
while(true){
if((i_12395 < n__7121__auto___12394)){
(a[i_12395] = reagent.impl.template.as_element((a[i_12395])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__7121__auto___12397 = a.length;
var i_12398 = (0);
while(true){
if((i_12398 < n__7121__auto___12397)){
var val_12399 = (a[i_12398]);
if((cljs.core.vector_QMARK_(val_12399)) && ((reagent.impl.template.key_from_vec(val_12399) == null))){
(o["no-key"] = true);
} else {
}

(a[i_12398] = reagent.impl.template.as_element(val_12399));

var G__12400 = (i_12398 + (1));
i_12398 = G__12400;
continue;
} else {
}
...
var G__12402 = (cljs.core.count(argv) - first_child);
switch (G__12402) {
case (0):
...
break;
default:
return (React["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__12402){
